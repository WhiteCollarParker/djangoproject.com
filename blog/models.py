    ...
    def save(self, *args, **kwargs):
        if self.content_format == "html":
            ...
            self.summary_html = publish_parts(
                source=self.summary, writer_name="html", settings_overrides=BLOG_DOCUTILS_SETTINGS
            )["fragment"]
            self.body_html = publish_parts(
                source=self.body, writer_name="html", settings_overrides=BLOG_DOCUTILS_SETTINGS
            )["fragment"]
...
class Joke(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse("weblog:joke", kwargs=kwargs)
